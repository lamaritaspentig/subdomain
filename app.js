...
function gas(method, ...args) {
  return new Promise((resolve, reject) => {
    ...
    const tunnelMethods = new Set([
      'getTunnelData',
      'listPublishedApplications',
      'createPublishedApplication',
      'updatePublishedApplication',
      'deletePublishedApplication'
    ]);
    const timeoutMs = tunnelMethods.has(method) ? 45000 : 30000;
